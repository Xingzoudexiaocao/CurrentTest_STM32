...
#if USE_LV_FONT_MYFONT_20 != 0
    lv_font_add(&lv_font_myfont_20, NULL);
#endif

#if USE_LV_FONT_MYFONT_16 != 0
    lv_font_add(&lv_font_myfont_16, NULL);
#endif

#if USE_LV_FONT_MYFONT_86 != 0
    lv_font_add(&lv_font_myfont_86, NULL);
#endif
