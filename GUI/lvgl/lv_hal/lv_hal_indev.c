...
/*
********************************************************************************
*                    static bool lv_mybutton_Read(u8 ButtonNo)
* Description:  
*               
* Arguments  : 
* Returns    :            
**********************************************************************************
*/
 static bool lv_mybutton_Read(lv_indev_data_t *data)
 {
//	u8 button_state = Button_Read(BUTTON1); //读取按键当前状态
//	 
//	if(button_state == BUTTON_NULL) //没按下
//	{
//		data->state = LV_INDEV_STATE_REL;
//	}
//	else //按下的状态
//	{
//		data->btn = button_state;
...
//	MyButtonInit(); //?????
	...
	indev_drv.read = lv_mybutton_Read;
