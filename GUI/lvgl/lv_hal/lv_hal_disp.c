...
static void tft_flush(int32_t x1, int32_t y1, int32_t x2, int32_t y2, const lv_color_t * color_p)
{
	...
	LCD_Color_Fill((uint16_t)act_x1, (uint16_t)act_y1, (uint16_t)act_x2, (uint16_t)act_y2, (uint16_t *)color_p);
	
//	u16 x,y;
//	uint16_t mycolor;
//	
//	/*Put the map to the remaining area*/
//    for(y = (u16)act_y1; y <= act_y2; y++)
//    {
//        for(x = (u16)act_x1; x <= act_x2; x++)
//        {
//            /*Your specific function comes here!*/
//            /*my_put_pixel(x, y, color_p->full);*/
//						mycolor = lv_color_to16(*color_p);
//            LCD_SetPointPixel(x, y,(mycolor));
//            color_p++;
//        }
...
static void tft_fill(int32_t x1, int32_t y1, int32_t x2, int32_t y2, lv_color_t color)
{
    ...
    for(y = (u16)act_y1; y <= act_y2; y++)
    {
        for(x = (u16)act_x1; x <= act_x2; x++)
        {
            /*Your specific function comes here!*/
            /*my_put_pixel(x, y, color_p->full);*/
            LCD_SetPointPixel(x, y,color.full);
        }
...
static void tft_map(int32_t x1, int32_t y1, int32_t x2, int32_t y2, const lv_color_t * color_p)
{
    ...
    for(y = act_y1; y <= act_y2; y++)
    {
        for(x = act_x1; x <= act_x2; x++)
        {
            /*Your specific function comes here!*/
            /*my_put_pixel(x, y, color_p->full);*/
            LCD_SetPointPixel(x, y,  ((color_p->full) | 0xFF00));
            color_p++;
        }
