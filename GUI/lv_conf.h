...
#define LV_INDEV_READ_PERIOD            0                     /*Input device read period in milliseconds*/
...
#define USE_LV_FONT_MYFONT_20			 			   8
#define USE_LV_FONT_MYFONT_16			  			 8
#define USE_LV_FONT_MYFONT_86							 8
