...
////////////////////////////////////////////////////////////////////
//-----------------LCD端口定义---------------- 
#define	LCD_LED HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET) 				//LCD背光    	PC10 
 
#define	LCD_CS_SET  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_SET)    //片选端口  		PC9
#define	LCD_RS_SET	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET)    //数据/命令 		PC8	   
#define	LCD_WR_SET	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, GPIO_PIN_SET)    //写数据			PC7
#define	LCD_RD_SET	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, GPIO_PIN_SET)    //读数据			PC6
								    
#define	LCD_CS_CLR  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_RESET)     //片选端口  		PC9
#define	LCD_RS_CLR	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET)     //数据/命令		PC8	   
#define	LCD_WR_CLR	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, GPIO_PIN_RESET)     //写数据			PC7
#define	LCD_RD_CLR	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, GPIO_PIN_RESET)     //读数据			PC6   
...
#define WHITE         	 0xFFFF
#define BLACK         	 0x0000	  
#define BLUE         	 0xF800  		// 红蓝反了
#define BRED             0XF81F
#define GRED 			 0XFFE0
#define GBLUE			 0X07FF
#define RED           	 0x001F		// 红蓝反了
...
extern void LCD_SetPointPixel(uint16_t usX,uint16_t usY,uint16_t usColor);
